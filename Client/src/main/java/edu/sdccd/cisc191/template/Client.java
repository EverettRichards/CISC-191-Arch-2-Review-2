            ...
            if (!subjectPopup.isShowing()) {
                ...
                subjectSubmit.setOnAction(e2 -> {
                    try {
                        ...
                        String subjectNumber = inputSubjectNumber.getText();
                        if (subjectName.contains("-")) {
                            throw new InvalidSubjectException("Invalid input: \"" + subjectName + "\"");
                        } else if (subjectNumber.contains("-")) {
                            throw new InvalidSubjectException("Invalid input: \"" + subjectNumber + "\"");
                        }
                        userSubject.setSubjectName(subjectName);
                        userSubject.setSubjectNumber(subjectNumber);
                        subjectBox.getItems().add(userSubject.getSubject());
                        subjectButton.setText("New Subject");
                        subjectPopup.hide();
                    ...
                    } catch (InvalidSubjectException err){
